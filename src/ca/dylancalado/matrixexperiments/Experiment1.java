...
public class Experiment1 
{
    public static void runExperiment1()
    {
        ...
        Timer.endTimer();
        System.out.println("Row-major access time: " + Timer.calculateSortTime() + " nanoseconds");
        columnMajorAccess(100, 100, m1, columnMajorMapping(m1, matrix1));
        Timer.endTimer();
        System.out.println("Column-major access time: " + Timer.calculateSortTime() + " nanoseconds\n");
